...
| หมวด | หัวข้อ |
|------|-------|
| [1](#1-โครงสร้างไฟล์) | โครงสร้างไฟล์ |
| [2](#2-สิ่งที่ต้องมีก่อนรัน) | สิ่งที่ต้องมีก่อนรัน |
| [3](#3-การติดตั้ง) | การติดตั้ง |
| [4](#4-การตั้งค่า-env) | การตั้งค่า .env |
| [5](#5-การรัน-server) | การรัน Server |
| [6](#6-การเชื่อมต่อจาก-ipad-หรือมือถือ) | การเชื่อมต่อจาก iPad หรือมือถือ |
| [7](#7-การใช้งานกับ-discord-obs-หรือโปรแกรมอื่น) | การใช้งานกับ Discord / OBS หรือโปรแกรมอื่น |
| [8](#8-การปรับแต่ง) | การปรับแต่ง |
| [9](#9-การแก้ไขปัญหา) | การแก้ไขปัญหา |
| [10](#10-อธิบายศัพท์เทคนิค-glossary) | อธิบายศัพท์เทคนิค (Glossary) |

> 💡 **อยากรู้ว่า miclink เกิดมาได้ยังไง? ใช้เทคนิคอะไรเบื้องหลัง?**
> → อ่านได้ที่ [`docs/DEVELOP.md`](DEVELOP.md) — เรื่องราวการพัฒนา + วิธีทำงานแบบละเอียด
...
## 5.4 🔒 โหมด Secure (HTTPS + WSS) — ใช้กับ iOS โดยเฉพาะ
...
## 6. การเชื่อมต่อจาก iPad หรือมือถือ
